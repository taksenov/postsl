...
// PipelineGolang all fields for PipelineIlium965 pipeline.
type PipelineIlium965 struct {
...
// Generate for PipelineIlium965.
func (t *PipelineIlium965) Generate(dst string, tmpl string) error {
	return filesystem.GeneratePipe(t, dst, tmpl)
}

// NewPipelineGolang constructor.
func NewPipelineIlium965(data map[string]string) Pipeline {
	return &PipelineIlium965{
		...
		Test:                             data["Test"],
		CheckDeferRowsClose:              data["CheckDeferRowsClose"],
		Lint:                             data["Lint"],
